...
// Simulated Logs generated by TrustGuard DPI proxy
const MOCK_LOGS = [
    {
        id: 'evt_1',
...
version: "1.2.0"
description: "Global DPI proxy rules for TrustGuard"
...
const PORT = 3001;
app.listen(PORT, () => {
    console.log(`Governance Backend running on http://localhost:${PORT}`);
});
