const PATTERNS = [
  ...
  { id: 'PHONE_IN_PREFIXED', regex: /\b(\+91|0)?[6-9][0-9]{9}\b/g, severity: 'medium', label: 'Indian Phone Number' },
  ...
  { id: 'AADHAAR_CONTEXT', regex: /\baadhaar\b.{0,40}\b\d{4}[\s-]?\d{4}[\s-]?\d{4}\b/gi, severity: 'high', label: 'Aadhaar Number' },
  { id: 'PAN', regex: /\b[A-Z]{5}[0-9]{4}[A-Z]\b/g, severity: 'high', label: 'PAN Card Number' },
  { id: 'UPI_ID', regex: /\b[A-Za-z0-9._-]+@[A-Za-z]{3,}\b/g, severity: 'medium', label: 'UPI ID' },
